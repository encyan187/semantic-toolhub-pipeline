...
#MODEL_ID = "gemini-2.5-flash"   # gemini-2.5-pro or gemini-2.5-flash
#API_KEY = ""
...
SYSTEM_MSG = ("You are a strict single label classifier for semantic software tools. "
                    f"AllowedCategories = {json.dumps(ALLOWED_JSON)}\n"
                    "- Choose zero or one categories ONLY from AllowedCategories.\n"
...
In the following format: [categorie]. Keep in mind to only predict categories from the taxonomy.
Make sure you keep this format. Do NOT write any sentences as answers. Only the categories as output.

What categorie does the following tool belong to?
